...
export const AUDIT_ACTIONS = {
  ...
  // 组织连接（tenant-mcp）
  TENANT_MCP_HOST_REGISTERED:  'TENANT_MCP_HOST_REGISTERED',
  TENANT_MCP_HOST_UPDATED:     'TENANT_MCP_HOST_UPDATED',
  TENANT_INTEGRATION_ENABLED:  'TENANT_INTEGRATION_ENABLED',
  TENANT_INTEGRATION_UPDATED:  'TENANT_INTEGRATION_UPDATED',
  TENANT_INTEGRATION_DISABLED: 'TENANT_INTEGRATION_DISABLED',
}
...
export const RESOURCE_TYPES = {
  ...
  TENANT_MCP_HOST:    'TENANT_MCP_HOST',
