...
from oap_mcp_host.env import OAP_CONFIG_DIR, RESOURCE_DIR
from oap_mcp_host.host.conf import CheckpointerConfig, LogConfig
from oap_mcp_host.httpd.conf.arguments import StrPath
...
class ServiceConfig(BaseModel):
    ...
    local_file_cache_prefix: str = "oap_mcp_host"
    ...
    logging_config: dict[str, Any] = {
        ...
        "loggers": {"oap_mcp_host": {"level": "INFO"}},
    }
...
class ServiceManager:
    ...
    def __init__(self, config_path: str | None = None) -> None:
        ...
        self._config_path: str = config_path or str(OAP_CONFIG_DIR / "oap_httpd.json")
