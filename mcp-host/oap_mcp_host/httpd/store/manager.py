...
from oap_mcp_host.host.store.base import FileType, StoreManagerProtocol, StoreProtocol
from oap_mcp_host.httpd.store.local import LocalStore
from oap_mcp_host.plugins.registry import HookInfo, PluginManager

type GetStoreCallback = Callable[[], Coroutine[Any, Any, StoreProtocol]]

StoreHookName = "oap_mcp_host.httpd.store"
