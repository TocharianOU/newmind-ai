...
from oap_mcp_host.host.agents.file_in_additional_kwargs import (
    DOCUMENTS_KEY,
    IMAGES_KEY,
    OAP_MIN_COUNT,
)
from oap_mcp_host.host.agents.message_order import FAKE_TOOL_RESPONSE
from oap_mcp_host.host.custom_events import ToolCallProgress
from oap_mcp_host.host.errors import LogBufferNotFoundError
from oap_mcp_host.host.store.base import FileType, StoreManagerProtocol
from oap_mcp_host.host.tools.log import LogEvent, LogManager, LogMsg
...
from oap_mcp_host.httpd.conf.project_context import get_project_dir
...
from oap_mcp_host.log import TRACE
...
class ChatProcessor:
    ...
    def __init__(
        ...
        if app.long_term_memory_store:
            from oap_mcp_host.host.agents.memory_retriever import MemoryRetriever
            from oap_mcp_host.host.agents.entity_extractor import EntityExtractor
            from oap_mcp_host.host.agents.simple_entity_extractor import SimpleEntityExtractor
