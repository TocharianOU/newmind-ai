...
from oap_mcp_host.host.conf import HostConfig, ServerConfig
from oap_mcp_host.host.conf.llm import LLMConfig
from oap_mcp_host.host.host import AttackTraceMcpHost
from oap_mcp_host.host.store.base import StoreManagerProtocol
from oap_mcp_host.host.store.memory_store import LongTermMemoryStore
from oap_mcp_host.httpd.abort_controller import AbortController
from oap_mcp_host.httpd.conf.command_alias import CommandAliasManager
...
from oap_mcp_host.httpd.conf.prompt import PromptManager
...
from oap_mcp_host.httpd.database.encryption import DatabaseEncryption
from oap_mcp_host.httpd.middlewares.plugins import PluginMiddlewaresManager
from oap_mcp_host.httpd.routers.plugins import RouterPlugin
from oap_mcp_host.httpd.store.cache import LocalFileCache
from oap_mcp_host.httpd.store.manager import StoreManager
from oap_mcp_host.plugins.registry import PluginManager, load_plugins_config
...
class AttackTraceHostAPI(FastAPI):
    ...
    async def prepare(self) -> AsyncGenerator[None, None]:
        ...
        try:
            from oap_mcp_host.httpd.database.orm_models import Base, LongTermMemory
