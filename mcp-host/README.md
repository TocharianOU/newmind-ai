# Newmind Agent MCP Host

Newmind Agent MCP Host is a language model host service based on the Model Context Protocol (MCP), providing a unified interface to manage and interact with various language models.

## Purpose of the Program

Newmind Agent MCP Host offers the following features:
...
from dive_mcp_host.host import NewmindMcpHost
