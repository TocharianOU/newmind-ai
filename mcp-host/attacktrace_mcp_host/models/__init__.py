...
from attacktrace_mcp_host.models.helpers import clean_model_kwargs
    ...
    **kwargs: Any,
    ...
    Args:
        provider: provider name. Two special providers are supported:
            - "dive": use the model in attacktrace_mcp_host.models
    ...
    If the provider is "dive", it should be like this:
        import attacktrace_mcp_host.models.model_name_in_lower_case as model_module
    ...
    if provider == "dive":
        ...
        model_module = import_module(
            f"attacktrace_mcp_host.models.{model_name_lower}",
        )
        model = model_module.load_model(*args, **kwargs)
    elif provider == "oap":
