...
from attacktrace_mcp_host.host.agents.file_in_additional_kwargs import (
    DOCUMENTS_KEY,
    IMAGES_KEY,
    OAP_MIN_COUNT,
)
from attacktrace_mcp_host.host.agents.message_order import FAKE_TOOL_RESPONSE
from attacktrace_mcp_host.host.custom_events import ToolCallProgress
from attacktrace_mcp_host.host.errors import LogBufferNotFoundError
...
class ChatProcessor:
    ...
    def __init__(
        ...
        if app.long_term_memory_store:
            from attacktrace_mcp_host.host.agents.memory_retriever import MemoryRetriever
            from attacktrace_mcp_host.host.agents.entity_extractor import EntityExtractor
            from attacktrace_mcp_host.host.agents.simple_entity_extractor import SimpleEntityExtractor
