...
```bash
docker run -d --name attacktrace-docs -p 8002:8002 attacktrace-docs:1.0
```
...
```bash
docker run -d --name attacktrace-docs -p YOUR_PORT:8002 attacktrace-docs:1.0
```
