...
Official user documentation for AttackTrace desktop application.
...
```bash
docker build -t attacktrace-docs .
```

### Run Container

```bash
docker run -p 8002:8002 attacktrace-docs
```
