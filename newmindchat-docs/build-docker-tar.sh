...
# NewmindChat 文档 Docker 镜像一键打包脚本
# 使用方法：./build-docker-tar.sh

set -e  # 遇到错误立即退出

echo "================================"
echo "NewmindChat 文档 Docker 打包工具"
echo "================================"
echo ""

# 定义变量
IMAGE_NAME="newmindchat-docs"
IMAGE_TAG="1.0"
TAR_FILE="newmindchat-docs-1.0.tar"
...
echo ""
echo "# 本机启动容器："
echo "docker run -d --name newmindchat-docs -p 8002:8002 ${IMAGE_NAME}:${IMAGE_TAG}"
echo ""
echo "# 在其他机器导入并启动："
