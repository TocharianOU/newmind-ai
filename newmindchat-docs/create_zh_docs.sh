...
NewmindChat 提供强大的 AI 对话和工具集成功能。
...
1. [下载安装](../getting-started/download.md) NewmindChat
...
- macOS: `~/Library/Application Support/NewmindChat/`
- Windows: `%APPDATA%/NewmindChat/`
- Linux: `~/.config/NewmindChat/`
DOC
